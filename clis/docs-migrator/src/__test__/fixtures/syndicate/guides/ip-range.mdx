...
](/open-api/admin/get-ip-range). Note that `id` returned in the response body can be used below for updating a range so keep it handy if needed.
...
If you haven't sent your first transaction yet, follow our [Send and Monitor Transactions Guide](/guides/transactions) to get started.

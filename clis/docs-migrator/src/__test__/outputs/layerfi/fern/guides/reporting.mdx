...
More detail on using Layer's embedded UI components is available [here](embedded-components.mdx). Reach out to your Layer contact for a full list of embedded reporting components.

## API

### Retrieving a Profit & Loss report
To build your own Profit & Loss report UI make a call to the [retrieve a Profit and Loss Report](../api-reference/get-profit-and-loss-report-for-business.mdx) endpoint.
...
The API will respond with the generated [Profit and Loss Report](../api-reference/pnl.mdx).
...
### Supported reports
A full list of supported reports is available in the [API reference](../api-reference/pnl.mdx)
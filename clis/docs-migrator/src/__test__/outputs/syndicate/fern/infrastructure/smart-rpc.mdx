...
- **Managed Gas benefits**
  ...
  With Syndicate’s [Managed Gas](managed-gas.mdx) enabled, there’s no need to manually top up funds to subsidize transactions. We handle this for you automatically.

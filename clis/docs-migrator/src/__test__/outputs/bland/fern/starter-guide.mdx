...
To send a phone call programatically, read the <a href="api-v1/post/calls.mdx">API reference</a>.
...
<CardGroup cols={2}>
  ...
  <Card title="Custom tools" icon="hammer" href="tutorials/custom-tools.mdx">

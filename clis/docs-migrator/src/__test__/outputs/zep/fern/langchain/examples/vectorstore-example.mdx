...
<Note>
    **You can generate a project api key in [Zep Dashboard](https://app.getzep.com/projects).**
</Note>
...
<Note>
    **Need a project API key? Create one from the [Zep Dashboard](https://app.getzep.com/projects).**
</Note>

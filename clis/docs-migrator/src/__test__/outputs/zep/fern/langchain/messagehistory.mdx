...
<Note>
    **You can find a complete [Message History Example](examples/messagehistory-example.mdx) that showcases how to use the `ZepChatMessageHistory` class in the chain.**
</Note>

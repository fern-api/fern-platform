...
<img
    style={{width: "40%"}}
    alt="Zep Cloud Memory Flowise Node"
    src="../images/flowise-memory-node.png"
/>
...
<Info>Learn more about [Zep Collections](../document-collections.mdx)</Info>
...
<img
    style={{width: "40%"}}
    alt="Zep Cloud Collection Flowise Node"
    src="../images/flowise-collection-node.png"
/>
...
<img
    alt="Zep Cloud Collection Flowise Node Complete Example"
    src="../images/flowise-collection-node-complete.png"
/>
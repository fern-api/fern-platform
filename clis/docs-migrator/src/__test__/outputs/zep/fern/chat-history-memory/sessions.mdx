...
Sessions represent a conversation. Sessions can be associated with [Users](../users.mdx) in a 1:M relationship.
...
<Info>Looking to associate a Session with a User? Check out our [User Management](../users.mdx) docs.</Info>

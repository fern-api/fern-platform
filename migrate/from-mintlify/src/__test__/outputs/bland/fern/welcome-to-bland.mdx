...
<CardGroup cols={2}>
  <Card title="Send phone calls" icon="phone-arrow-up-right" href="api-v1/post/calls.mdx">
    Dispatch AI phone calls to call customers, leads, and to streamline operations.
  </Card>
  <Card title="Set up inbound numbers" icon="phone-arrow-down-left" href="api-v1/post/inbound-purchase.mdx">
    Create inbound phone numbers for customer support, etc.
  </Card>
  <Card title="Do live function calling" icon="bolt" href="tutorials/custom-tools.mdx">
    Connect external APIs and take live actions during phone calls.
  </Card>
  <Card title="Extract structured data from calls" icon="brackets-curly" href="api-v1/post/calls-id-analyze.mdx">
    Extract JSON data to answer questions about your calls.
  </Card>
  <Card title="Create call campaigns" icon="megaphone" href="api-v1/post/batches.mdx">
...
<CardGroup cols={2}>
  ...
  <Card title="Starter guide" icon="rocket-launch" href="starter-guide.mdx">

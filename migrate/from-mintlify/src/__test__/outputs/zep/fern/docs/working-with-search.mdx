...
<Card title="Searching in Zep" icon="magnifying-glass">
    Zep's Collection and Memory search supports semantic similarity search and similarity search re-ranked by [Maximal Marginal Relevance](#maximal-marginal-relevance-re-ranking).

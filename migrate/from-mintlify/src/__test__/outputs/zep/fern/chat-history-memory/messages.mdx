...
<Card
    ...
    icon="message"
>
Messages are the individual components of a conversation, each linked to a [Session](sessions) in a many-to-one relationship.
To incorporate messages into sessions, utilize the [Memories](memories) feature.
</Card>

...
<Note>
    **You can find a complete [Message History Example](examples/messagehistory-example) that showcases how to use the `ZepChatMessageHistory` class in the chain.**
</Note>

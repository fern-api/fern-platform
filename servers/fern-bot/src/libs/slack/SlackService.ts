...
export class SlackService {
  ...
  getOrganizationName(
    ...
    if (inTitle) {
      ...
      return organization
        ? organization
        : "Org Not Found (you may need that CLI upgrade)";
    }
  }
  ...
  public async notifyStaleUpgradePRs({
    ...
    const maybeVersionUpdateMessage =
      this.getStaleVersionUpgradePRsMessage(versionUpdatePulls);
  ...
  getStaleVersionUpgradePRsMessage(
    versionUpdatePulls: PullRequest[]

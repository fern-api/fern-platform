...
export class FdrDeployStack extends Stack {
    constructor(
        ...
        const cloudMapNamespace =
            PrivateDnsNamespace.fromPrivateDnsNamespaceAttributes(
                ...
                {
                    namespaceArn:
                        environmentInfo.cloudMapNamespaceInfo.namespaceArn,
                    namespaceId:
                        environmentInfo.cloudMapNamespaceInfo.namespaceId,
                ...
                taskImageOptions: {
                    ...
                    environment: {
                        ...
                        PRIVATE_S3_BUCKET_REGION:
                            privateDocsBucket.stack.region,
                        ...
                        ALGOLIA_APP_ID:
                            getEnvironmentVariableOrThrow("ALGOLIA_APP_ID"),
        ...
        lbUnhealthyHostCountAlarm.addAlarmAction(
    ...
    private constructElastiCacheInstance(
        ...
        const cacheSubnetGroupName =
            envPrefix + props.cacheName + "SubnetGroup";
        const cacheSubnetGroup = new CfnSubnetGroup(
            this,
            cacheSubnetGroupName,
            {
                description: `${cacheSubnetGroupName} CDK`,
                cacheSubnetGroupName,
                subnetIds: props.IVpc.publicSubnets.map(
                    ({ subnetId }) => subnetId
                ),
            }
        );

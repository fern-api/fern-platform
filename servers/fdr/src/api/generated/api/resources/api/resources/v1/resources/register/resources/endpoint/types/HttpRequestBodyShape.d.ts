...
export declare type HttpRequestBodyShape = FernRegistry.api.v1.register.HttpRequestBodyShape.Object_ | FernRegistry.api.v1.register.HttpRequestBodyShape.Reference | FernRegistry.api.v1.register.HttpRequestBodyShape.Json
/**
 * `fileUpload` is optional only to be backwards compatible. It should be required. */
 | FernRegistry.api.v1.register.HttpRequestBodyShape.FileUpload | FernRegistry.api.v1.register.HttpRequestBodyShape.Bytes;

...
export declare type HttpRequestBodyShape = FernRegistry.api.v1.read.HttpRequestBodyShape.Object_ | FernRegistry.api.v1.read.HttpRequestBodyShape.Reference
/**
 * `fileUpload` is optional only to be backwards compatible. It should be required. */
 | FernRegistry.api.v1.read.HttpRequestBodyShape.FileUpload | FernRegistry.api.v1.read.HttpRequestBodyShape.Bytes;

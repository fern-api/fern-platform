      ...
      case "map":
        return {
          ...
          ...getAllReferencedTypesFromReference({
            reference: reference.keyType,
            results,
          }),
          ...getAllReferencedTypesFromReference({
            reference: reference.valueType,
            results,
          }),
        };
      case "list":
    ...
    switch (definition.shape.type) {
      case "object": {
        return {
          ...
          ...definition.shape.properties.reduce<ReferencedTypes>(
            (base, value) => {
              return {
                ...base,
                ...getAllReferencedTypesFromReference({
      ...
      case "discriminatedUnion":
        return {
          ...results,
          ...definition.shape.variants.reduce<ReferencedTypes>(
            (base, value) => {
              return {
                ...base,
                ...getAllReferencedTypesFromDefinition({

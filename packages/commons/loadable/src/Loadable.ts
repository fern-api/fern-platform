export type Loadable<V, E = unknown> =
    | NotStartedLoading<V>
    | Loading<V>
    | Loaded<V>
    | Failed<E>;
...
const NOT_STARTED_LOADING: NotStartedLoading<unknown> = Object.freeze({
    type: "notStartedLoading",
});
...
export function isNotStartedLoading<V>(
    loadable: Loadable<V>
): loadable is NotStartedLoading<V>;
export function isNotStartedLoading<V>(
    loadable: Loadable<V> | undefined
): loadable is NotStartedLoading<V> | undefined {
...
export function isLoading<V>(
    loadable: Loadable<V> | undefined
): loadable is Loading<V> | undefined;
...
export function isLoaded<V>(
    loadable: Loadable<V> | undefined
): loadable is Loaded<V> {
...
export function isFailed<V, E>(
    loadable: Loadable<V, E> | undefined
): loadable is Failed<E> {

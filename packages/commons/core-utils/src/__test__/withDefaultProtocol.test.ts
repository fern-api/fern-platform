...
describe("withDefaultProtocol", () => {
    ...
    it("does not modify URLs with other protocols", () => {
        expect(withDefaultProtocol("ftp://example.com")).toBe(
            "ftp://example.com"
        );
    });
    ...
    it("handles URLs with query parameters", () => {
        expect(
            withDefaultProtocol("example.com?param1=value1&param2=value2")
        ).toBe("https://example.com?param1=value1&param2=value2");
    });
    ...
    it("handles URLs with :// in the path", () => {
        expect(
            withDefaultProtocol(
                "example.com/path/to/resource/with/colon://in/path"
            )
    ...
    it("handles URLs with :// in query parameters", () => {
        expect(
            withDefaultProtocol(
                "example.com?param1=value1&param2=colon://in/value"
            )
    ...
    it("handles URLs with :// in fragment", () => {
        expect(
            withDefaultProtocol("example.com/path#fragment://with/colon")
        ).toBe("https://example.com/path#fragment://with/colon");
    });

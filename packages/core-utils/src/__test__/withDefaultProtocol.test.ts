...
describe("withDefaultProtocol", () => {
    ...
    it("handles URLs with :// in the path", () => {
        expect(withDefaultProtocol("example.com/path/to/resource/with/colon://in/path")).toBe(
            "https://example.com/path/to/resource/with/colon://in/path",
        );
    });

    it("handles URLs with :// in query parameters", () => {
        expect(withDefaultProtocol("example.com?param1=value1&param2=colon://in/value")).toBe(

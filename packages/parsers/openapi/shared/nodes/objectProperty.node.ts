...
> {
    ...
    toFdrShape = (): FdrAPI.api.latest.ObjectProperty | undefined => {
        const valueShape = this.valueShape.toFdrShape();
        ...
        return {
            ...
            // TODO: update to availability: this.availability.toFdrShape(),
        };
    };
}

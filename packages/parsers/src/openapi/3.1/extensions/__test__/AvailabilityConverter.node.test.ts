...
} from "../AvailabilityConverter.node";
...
describe("AvailabilityConverterNode", () => {
    ...
    describe("parse", () => {
        ...
        it("sets availability to undefined and warns when x-fern-availability is invalid", () => {
            const converter = new AvailabilityConverterNode({
                input: {
                    "x-fern-availability": "invalid" as Availability,
                } as OpenAPIV3_1.SchemaObject,
                context: mockContext,
                accessPath: [],
                pathId: "",
    ...
    describe("convert", () => {
        ...
        it("converts in-development to InDevelopment", () => {
            ...
            expect(converter.convert()).toBe(
                FernRegistry.Availability.InDevelopment
            );
        });
        ...
        it("converts generally-available to GenerallyAvailable", () => {
            ...
            expect(converter.convert()).toBe(
                FernRegistry.Availability.GenerallyAvailable
            );
        });
        ...
        it("converts deprecated to Deprecated", () => {
            ...
            expect(converter.convert()).toBe(
                FernRegistry.Availability.Deprecated
            );
        });

...
export class XFernSdkMethodNameConverterNode extends BaseOpenApiV3_1ConverterNode<unknown, string | undefined> {
    ...
    parse(): void {
        this.sdkMethodName = extendType<XFernSdkMethodNameConverter.Input>(this.input)[X_FERN_SDK_METHOD_NAME];
    }

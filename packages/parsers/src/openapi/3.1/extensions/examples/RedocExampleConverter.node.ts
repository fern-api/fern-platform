...
import { REDOC_CODE_SAMPLES_CAMEL, REDOC_CODE_SAMPLES_KEBAB } from "../openApiExtension.consts";
...
> {
    ...
    convert(): Record<string, FernRegistry.api.latest.CodeSnippet[]> | undefined {
        const convertedCodeSamples: Record<string, FernRegistry.api.latest.CodeSnippet[]> = {};
        this.codeSamples?.forEach((codeSample) => {

...
> {
    ...
    validateFormDataRequestExample(): boolean {
        ...
        return Object.entries(this.requestBody?.fields ?? {}).reduce((result, [key, field]) => {
            ...
            switch (field.multipartType) {
                case "file":
                    return result && (isFileWithData(value) || typeof value === "string");
                case "files": {
                    return (
                        result &&
                        Array.isArray(value) &&
                        value.every((value) => isFileWithData(value) || typeof value === "string")
                    );
                }
                case "property": {
                    return result;
        ...
        if (this.responseBody && this.resolvedResponseInput) {
            switch (this.responseBody.contentType) {
                case "application/json":
                    if (
                        (this.resolvedResponseInput != null && typeof this.resolvedResponseInput !== "object") ||
                ...
                case "text/event-stream":
                    if (
                        ...
                        this.context.errors.error({
                            message: "Invalid example, expected array of SSE events for event-stream",
                            path: this.accessPath,
                        });
                        return;
                    }
                ...
                case "application/octet-stream":
                    if (
                        ...
                        this.context.errors.error({
                            message: "Invalid example, expected string or array for octet-stream",
                            path: this.accessPath,
                        });
                        return;
                    }
    ...
    convertDescription(): string | undefined {
        if (this.resolvedRequestInput != null && this.resolvedResponseInput != null) {
        ...
        if (this.responseBody != null && this.resolvedResponseInput != null) {
            ...
            switch (this.responseBody.contentType) {
                case "application/json": {
                    responseBody = {
                        type: "json",
                        value: this.resolvedResponseInput?.value ?? this.resolvedResponseInput,
                    };
                    break;
                }
                case "text/event-stream":
                ...
                case "application/octet-stream":
                    responseBody = {
                        type: typeof this.resolvedResponseInput?.value === "string" ? "filename" : "stream",
                        value: this.resolvedResponseInput?.value ?? this.resolvedResponseInput,
                    };
                    break;
                case undefined:

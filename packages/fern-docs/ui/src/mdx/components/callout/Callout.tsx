    ...
    return (
        ...
        >
            <div className="flex items-start space-x-3">
                <div className="mt-0.5 w-4">
                    {typeof icon === "string" ? (
                        ...
                        visitDiscriminatedUnion({ intent }, "intent")._visit({
                            ...
                            note: () => (
                                <Pin className="size-icon-md text-intent-info" />
                            ),
                            launch: () => (
                                <Rocket className="t-accent size-icon-md" />
                            ),
                            tip: () => (
                                <Star className="size-icon-md text-intent-success" />
                            ),
                            check: () => (
                ...
                >
                    <div
                        className={visitDiscriminatedUnion(
                            { intent },
                            "intent"
                        )._visit({

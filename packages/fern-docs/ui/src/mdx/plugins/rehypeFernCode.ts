        ...
        visit(tree, (node, index, parent) => {
            ...
            if (
                ...
                parent?.children.splice(index, 1, {
                    ...
                    name: "CodeBlocks",
                    attributes: [
                        unknownToMdxJsxAttribute("items", codeBlockItems),
                    ],
                    children: [],
                });
                return "skip";
            ...
            if (isMdxJsxElementHast(node) && node.name === "CodeBlock") {
                ...
                if (codeBlockItems.length === 0) {
                    ...
                    parent?.children.splice(index, 1, {
                        type: "mdxJsxFlowElement",
                        name: "CodeBlock",
                        attributes: Object.entries(codeBlockItems[0]).map(
                            ([key, value]) =>
                ...
                if (head != null) {
                    ...
                    if (meta.title == null) {
                        ...
                        parent?.children.splice(index, 1, {
                            ...
                            name: "CodeBlocks",
                            attributes: [
                                unknownToMdxJsxAttribute("items", itemsProps),
                            ],
                            children: [],
                        });
                    }

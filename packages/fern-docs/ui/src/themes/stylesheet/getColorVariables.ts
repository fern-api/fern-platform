...
export function getColorVariables(
    ...
    const radixGrayscaleLight = getClosestGrayScale(
        tinycolor(
            shouldUseAccentColorLight
                ? accentPrimaryLightUi
    ...
    const headerBackgroundDark = getColor2(
        colorsV3,
        "headerBackground",
        "dark"
    );
    ...
    return {
        light: {
            [CSS_VARIABLES.GRAYSCALE_1]: getRadixGrayVar(
                radixGrayscaleLight,
                1
            ),
            [CSS_VARIABLES.GRAYSCALE_2]: getRadixGrayVar(
                radixGrayscaleLight,
                2
            ),
            [CSS_VARIABLES.GRAYSCALE_3]: getRadixGrayVar(
                radixGrayscaleLight,
                3
            ),
            [CSS_VARIABLES.GRAYSCALE_4]: getRadixGrayVar(
                radixGrayscaleLight,
                4
            ),
            [CSS_VARIABLES.GRAYSCALE_5]: getRadixGrayVar(
                radixGrayscaleLight,
                5
            ),
            [CSS_VARIABLES.GRAYSCALE_6]: getRadixGrayVar(
                radixGrayscaleLight,
                6
            ),
            [CSS_VARIABLES.GRAYSCALE_7]: getRadixGrayVar(
                radixGrayscaleLight,
                7
            ),
            [CSS_VARIABLES.GRAYSCALE_8]: getRadixGrayVar(
                radixGrayscaleLight,
                8
            ),
            [CSS_VARIABLES.GRAYSCALE_9]: getRadixGrayVar(
                radixGrayscaleLight,
                9
            ),
            [CSS_VARIABLES.GRAYSCALE_10]: getRadixGrayVar(
                radixGrayscaleLight,
                10
            ),
            [CSS_VARIABLES.GRAYSCALE_11]: getRadixGrayVar(
                radixGrayscaleLight,
                11
            ),
            [CSS_VARIABLES.GRAYSCALE_12]: getRadixGrayVar(
                radixGrayscaleLight,
                12
            ),
        ...
        dark: {
            ...
            [CSS_VARIABLES.ACCENT_SURFACE]:
                radixColorsDark.accentSurfaceWideGamut,

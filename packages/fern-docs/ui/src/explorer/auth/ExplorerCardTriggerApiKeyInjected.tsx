...
interface ExplorerCardTriggerApiKeyInjectedProps {
...
export function ExplorerCardTriggerApiKeyInjected({
  auth,
  config,
  disabled,
  toggleOpen,
  onClose,
}: ExplorerCardTriggerApiKeyInjectedProps): ReactElement | false {

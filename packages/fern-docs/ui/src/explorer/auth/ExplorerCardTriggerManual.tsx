...
import { ExplorerAuthState } from "../types";
import { pascalCaseHeaderKey } from "../utils/header-key-case";

interface ExplorerCardTriggerManualProps {
...
export function ExplorerCardTriggerManual({
  auth,
  disabled,
  toggleOpen,
  isOpen,
}: ExplorerCardTriggerManualProps): ReactElement | false {

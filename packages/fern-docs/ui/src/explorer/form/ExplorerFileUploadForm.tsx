...
export interface ExplorerFileUploadFormProps {
  id: string;
  propertyKey: string;
  type: "file" | "files";
  isOptional?: boolean;
...
export const ExplorerFileUploadForm = memo<ExplorerFileUploadFormProps>(
...
ExplorerFileUploadForm.displayName = "ExplorerFileUploadForm";

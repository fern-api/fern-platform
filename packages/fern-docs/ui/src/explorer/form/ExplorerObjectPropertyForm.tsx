...
import { ExplorerAdditionalProperties } from "./ExplorerAdditionalProperties";
...
interface ExplorerObjectPropertyFormProps {
  id: string;
...
export const ExplorerObjectPropertyForm: FC<
  ExplorerObjectPropertyFormProps
> = ({
  id,
  property,
  onChange,
...
interface ExplorerObjectPropertiesFormProps {
  id: string;
...
export const ExplorerObjectPropertiesForm =
  memo<ExplorerObjectPropertiesFormProps>((props) => {
    const {
      id,
      properties,
      onChange,
...
ExplorerObjectPropertiesForm.displayName = "ExplorerObjectPropertiesForm";

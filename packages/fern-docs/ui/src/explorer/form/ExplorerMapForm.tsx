...
interface ExplorerMapFormProps {
  id: string;
...
export const ExplorerMapForm = memo<ExplorerMapFormProps>((props) => {
...
interface ExplorerMapItemFormProps {
  idx: number;
  id: string;
  keyShape: TypeShapeOrReference;
  valueShape: TypeShapeOrReference;
...
ExplorerMapForm.displayName = "ExplorerMapForm";

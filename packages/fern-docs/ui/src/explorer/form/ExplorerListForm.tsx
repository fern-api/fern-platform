...
interface ExplorerListFormProps {
...
export const ExplorerListForm = memo<ExplorerListFormProps>(
...
interface ExplorerListItemFormProps {
  id: string;
  idx: number;
...
ExplorerListForm.displayName = "ExplorerListForm";

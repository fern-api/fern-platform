...
export declare namespace EndpointContentLeft {
    export interface Props {
        ...
        setSelectedError: (
            idx: ApiDefinition.ErrorResponse | undefined
        ) => void;
                        ...
                        visitDiscriminatedUnion(
                            ...
                            referencedEndpoint: () => ({
                                key: ApiDefinition.PropertyKey(
                                    clientCredentialsValue.value.headerName ||
                                        "Authorization"
                                ),
                                    ...
                                    {isAuth && (
                                        <div className="absolute right-0 top-3">
                                            <div className="px-2 bg-tag-danger rounded-xl flex items-center h-5">
                                                <span className="text-xs t-danger">
                                                    Auth
                                                </span>
                                            </div>
                                        </div>

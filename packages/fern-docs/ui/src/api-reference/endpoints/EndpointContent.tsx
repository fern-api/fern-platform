        ...
        selectAtom(
          atom((get): [number, number] => {
            ...
            const containerHeight =
              contentHeight - PADDING_TOP - PADDING_BOTTOM - selectorHeight;
            ...
            if (
              ...
              maxRequestContainerHeight + maxResponseContainerHeight <=
              ...
              const remainingContainerHeight =
                containerHeight - maxRequestContainerHeight - GAP_6;
              return [
              ...
              const remainingContainerHeight =
                containerHeight - maxResponseContainerHeight - GAP_6;
              return [

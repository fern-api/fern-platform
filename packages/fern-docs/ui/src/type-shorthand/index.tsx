    ...
    return visitDiscriminatedUnion(unwrapped.shape)._visit({
        ...
        primitive: (primitive) =>
            visitDiscriminatedUnion(primitive.value, "type")._visit({
                string: () =>
                    plural ? "strings" : maybeWithArticle("a", "string"),
                integer: () =>
                    plural ? "integers" : maybeWithArticle("an", "integer"),
                uint: () => (plural ? "uints" : maybeWithArticle("a", "uint")),
                uint64: () =>
                    plural ? "uint64s" : maybeWithArticle("a", "uint64"),
                double: () =>
                    plural ? "doubles" : maybeWithArticle("a", "double"),
                ...
                base64: () =>
                    plural
                        ? "Base64 strings"
                        : maybeWithArticle("a", "Base64 string"),
                date: () => (plural ? "dates" : maybeWithArticle("a", "date")),
                bigInteger: () =>
                    plural
                        ? "big integers"
                        : maybeWithArticle("a", "big integer"),
                _other: () => "<unknown>",
            }),

...
const useInkeepSettings = ():
    ...
    return {
        ...
        aiChatSettings: searchConfig.inkeep.aiChatSettings as
            | InkeepAIChatSettings
            | undefined,
        searchSettings: searchConfig.inkeep.searchSettings as
            | InkeepSearchSettings
            | undefined,
        modalSettings: searchConfig.inkeep.modalSettings as
            | InkeepModalSettings
            | undefined,
    };
};

    ...
    <Tooltip open={open}>
      ...
      <TooltipPortal>
        <TooltipContent
          ...
          sideOffset={16}
          align="start"
          className="max-h-(--radix-tooltip-content-available-height) max-w-[min(var(--radix-tooltip-content-available-width),384px)] space-y-2 [&_mark]:bg-(--accent-a3) [&_mark]:text-(--accent-a11)"
          avoidCollisions
          animate={false}
          collisionPadding={10}
        >

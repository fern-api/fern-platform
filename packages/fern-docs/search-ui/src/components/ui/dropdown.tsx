...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "border-border-default bg-(color:--grayscale-surface) text-(color:--color-border-concealed) rounded-3/2 z-50 min-w-[8rem] overflow-hidden border p-1 shadow-md backdrop-blur-xl",

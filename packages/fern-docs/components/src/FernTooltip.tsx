    ...
    >
      ...
      <Tooltip.Portal container={container}>
        <Tooltip.Content
          ...
          {...props}
          className={cn(
            "bg-background-translucent border-border-default animate-popover rounded-2 max-w-xs border p-2 text-xs leading-none shadow-sm backdrop-blur will-change-[transform,opacity]",
            props.className
          )}
        >
          {content}

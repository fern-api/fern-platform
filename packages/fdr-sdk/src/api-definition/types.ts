...
export type DereferencedTypeShape = Exclude<Latest.TypeShape, Latest.TypeShape.Alias>;
export type DereferencedTypeReference = Exclude<Latest.TypeReference, Latest.TypeReference.Id>;

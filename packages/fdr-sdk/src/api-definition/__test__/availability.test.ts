...
describe("coalesceAvailability", () => {
  it("should return the least stable availability level", () => {
    expect(coalesceAvailability([Availability.Stable, Availability.Beta])).toBe(
      Availability.Beta
    );
    expect(coalesceAvailability([Availability.Beta, Availability.Stable])).toBe(
      Availability.Beta
    );
    expect(
    ...
    expect(
      coalesceAvailability([Availability.Beta, Availability.InDevelopment])

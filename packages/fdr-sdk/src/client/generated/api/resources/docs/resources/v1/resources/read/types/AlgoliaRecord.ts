...
export type AlgoliaRecord =
    | FernRegistry.docs.v1.read.AlgoliaRecord.Endpoint
    | FernRegistry.docs.v1.read.AlgoliaRecord.Page
    | FernRegistry.docs.v1.read.AlgoliaRecord.EndpointV2
    | FernRegistry.docs.v1.read.AlgoliaRecord.PageV2;

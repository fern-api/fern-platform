...
export class ApiReferenceNavigationConverter {
        ...
        return this.#idgen.with(this.apiSection.urlSlug, (id) => {
            const overviewPageId =
                this.apiSection.navigation?.summaryPageId != null
                    ? FernNavigation.V1.PageId(
                          this.apiSection.navigation.summaryPageId
                      )
                    : undefined;
            const noindex =
                overviewPageId != null
            ...
            return {
                ...
                paginated:
                    this.paginated ??
                    (this.apiSection.longScrolling === false
                        ? true
                        : undefined),
                slug: slug.get(),
    ...
    private convertPackageToChildren(
        ...
        if (this.lexicographic) {
            toRet.sort((a, b) => {
                const aTitle =
                    a.type === "endpointPair" ? a.nonStream.title : a.title;
                const bTitle =
                    b.type === "endpointPair" ? b.nonStream.title : b.title;
                ...
                subpackage: ({ subpackageId, items, summaryPageId }) => {
                    ...
                    this.#idgen.with(subpackageId, (id) => {
                        ...
                        children.push({
                            ...
                            apiDefinitionId: this.apiDefinitionId,
                            pointsTo:
                                FernNavigation.V1.followRedirects(
                                    convertedItems
                                ),
                            playground: undefined,
                            authed: undefined,
    ...
    private mergeEndpointPairs(
        ...
        children.forEach((child) => {
            ...
            const pairNode: FernNavigation.V1.EndpointPairNode =
                this.#idgen.with("endpoint-pair", (id) => ({
                    id,
                    type: "endpointPair",

...
export const FernChip = forwardRef<HTMLButtonElement, FernChipProps>(
    ({ children, rounded = false, size = "lg", variant = "subtle", colorScheme = "gray", className, onClick }, ref) => {
        return (
            <button
                ref={ref}
                className={clsx(
                    ...
                    },
                    {
                        ...
                        // Green
                        "bg-green-a3 text-green-a11 hover:bg-green-a4": colorScheme === "green" && variant === "subtle",
                        "bg-green-a10 text-green-1 hover:bg-green-a11": colorScheme === "green" && variant === "solid",

                        // Blue
                        "bg-blue-a3 text-blue-a11 hover:bg-blue-a4": colorScheme === "blue" && variant === "subtle",
                        "bg-blue-a10 text-blue-1 hover:bg-blue-a11": colorScheme === "blue" && variant === "solid",

                        // Amber
                        "bg-amber-a3 text-amber-a11 hover:bg-amber-a4": colorScheme === "amber" && variant === "subtle",
                        "bg-amber-a10 text-amber-1 dark:text-amber-12 hover:bg-amber-a11":
                            colorScheme === "amber" && variant === "solid",

                        // Red
                        "bg-red-a3 text-red-a11 hover:bg-red-a4": colorScheme === "red" && variant === "subtle",
                        "bg-red-a10 text-red-1 hover:bg-red-a11": colorScheme === "red" && variant === "solid",

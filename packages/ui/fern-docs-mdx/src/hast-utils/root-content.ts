...
export function extractElementsFromRootContentHast(children: RootContent[]): RootContentToElementContentReturnType {
    return children.reduce<RootContentToElementContentReturnType>(
        (acc, child) => mergeRootContentToElementContentReturnTypes(acc, rootContentToElementContent(child)),
        { elements: [], nonelements: [] },
    );
}

function rootContentToElementContent(child: RootContent): RootContentToElementContentReturnType {
    switch (child.type) {
        case "comment":
        case "element":
        case "text":
...
function mergeRootContentToElementContentReturnTypes(
    ...
    return { elements: [...a.elements, ...b.elements], nonelements: [...a.nonelements, ...b.nonelements] };
}

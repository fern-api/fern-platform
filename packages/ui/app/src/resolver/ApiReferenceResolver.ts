...
export class ApiReferenceResolver {
    public static async resolve(
        ...
        const resolver = new ApiReferenceResolver(root, holder, typeResolver, pages, featureFlags, mdxOptions);
        return resolver.resolveApiDefinition();
    }

    private resolvedTypes: Record<string, ResolvedTypeDefinition> = {};

    private definitionResolver: ApiDefinitionResolver;
    private constructor(
        ...
        this.definitionResolver = new ApiDefinitionResolver(
            this.holder,
            typeResolver,
            this.resolvedTypes,
            featureFlags,

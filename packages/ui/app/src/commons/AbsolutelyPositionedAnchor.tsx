...
export const AbsolutelyPositionedAnchor: React.FC<AbsolutelyPositionedAnchor.Props> = ({
    ...
    return (
        ...
        >
            <a href={`#${anchor}`}>
                <LinkIcon className="text-text-muted-light dark:text-text-muted-dark hover:text-text-primary-light hover:dark:text-text-primary-dark h-3.5 w-3.5 transition" />
            </a>
        </div>
    );
};

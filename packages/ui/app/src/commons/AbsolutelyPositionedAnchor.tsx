...
export const AbsolutelyPositionedAnchor: React.FC<AbsolutelyPositionedAnchor.Props> = ({ href, smallGap = false }) => {
    return (
        <div className="absolute">
            ...
            >
                <span className="zinc-box flex h-6 w-6 items-center justify-center rounded-md bg-white text-gray-400 ring-1 ring-gray-400/30 hover:ring-gray-400/60 dark:bg-white/5 dark:ring-gray-700/25 dark:hover:ring-white/20">

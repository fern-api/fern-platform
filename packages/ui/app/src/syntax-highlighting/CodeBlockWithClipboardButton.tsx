...
export const CodeBlockWithClipboardButton: React.FC<PropsWithChildren<CodeBlockWithClipboardButtonProps>> = ({
    ...
    return (
        <div
            className={clsx(
                "not-prose group/cb-container bg-card relative mb-6 mt-4 flex w-full rounded-md shadow-sm  after:ring-default after:pointer-events-none after:absolute after:inset-0 after:rounded-md after:ring-1 after:ring-inset after:content-['']",
                {

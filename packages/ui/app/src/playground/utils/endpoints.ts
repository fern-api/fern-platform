...
export function getInitialEndpointRequestFormStateWithExample(
    ...
    return {
        ...
        pathParameters: {
            ...
            ...filterParams(playgroundInitialState?.path_parameters ?? {}, context?.endpoint.pathParameters ?? []),
        },
        queryParameters: {
            ...getEmptyValueForObjectProperties(
            ...
            ...filterParams(playgroundInitialState?.query_parameters ?? {}, context?.endpoint.queryParameters ?? []),
        },
        body:
            exampleCall != null
                ...
                : getEmptyValueForHttpRequestBody(context?.endpoint.request?.body, context?.types ?? EMPTY_OBJECT),
    };
}

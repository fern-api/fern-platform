                ...
                <FernDropdown
                    ...
                    onValueChange={(key) => {
                            ...
                            onChange((oldValue: unknown) => {
                                ...
                                return hiddenProperties.reduce((acc, property) => {
                                    const newValue = getDefaultValueForType(
                                        ApiDefinition.unwrapOptional(property.valueShape, types),
                                        types,
                                    );
                        ...
                        onChangeObjectProperty(
                            property.key,
                            getDefaultValueForType(ApiDefinition.unwrapOptional(property.valueShape, types), types) ??
                                "",
                        );
                    }}
                >
...
function shouldShowProperty(shape: ApiDefinition.ObjectProperty["valueShape"], value: unknown): boolean {

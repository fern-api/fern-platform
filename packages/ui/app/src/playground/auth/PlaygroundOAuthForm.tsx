...
function OAuthReferencedEndpointForm({
    ...
    if (context == null) {
        ...
        return <PlaygroundBearerAuthForm bearerAuth={{ tokenName: "token" }} disabled={disabled} />;
    }
...
export function PlaygroundOAuthForm({
    ...
    return visitDiscriminatedUnion(oAuth.value, "type")._visit({
        clientCredentials: (clientCredentials) => {
            return visitDiscriminatedUnion(clientCredentials.value, "type")._visit<ReactElement | false>({

...
export function ApiPackageContent(props: ApiPackageContentProps): ReactNode {
    ...
    switch (node.type) {
        ...
        case "webhook":
            return <Webhook node={node} apiDefinition={apiDefinition} breadcrumb={breadcrumb} last={last} />;
        case "webSocket":
            return <WebSocket node={node} apiDefinition={apiDefinition} breadcrumb={breadcrumb} last={last} />;
        case "page":
            return <ApiSectionMarkdownPage node={node} mdxs={mdxs} last={last} />;
        case "endpointPair":
            return (

...
export const EndpointRequestSection: React.FC<EndpointRequestSection.Props> = ({
    ...
    return (
        <div className="flex flex-col">
            ...
            <div className="text-text-muted-light dark:text-text-muted-dark border-border-default-light dark:border-border-default-dark border-b pb-5 text-sm leading-6">

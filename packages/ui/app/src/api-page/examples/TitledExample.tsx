...
export const TitledExample = forwardRef<HTMLDivElement, PropsWithChildren<TitledExample.Props>>(function TitledExample(
    ...
    return (
        <div
            className={cn(
                "rounded-lg overflow-hidden flex flex-col bg-card after:ring-default after:pointer-events-none after:absolute after:inset-0 after:rounded-[inherit] after:ring-1 after:ring-inset after:content-[''] relative shadow-sm",
        ...
        >
            <div
                className={cn("rounded-t-lg h-10", {
            ...
            >
                <div className="mx-px flex min-h-10 items-center justify-between rounded-t-lg px-2 shadow-[inset_0_-1px_0_0] shadow-border-default">
                    {typeof title === "string" ? (
                        <div

...
export const Docs: React.FC = () => {
    ...
    return (
        <div className="relative flex min-h-0 flex-1 flex-col">
            ...
            <div className="border-border-default-light dark:border-border-default-dark bg-background-light dark:bg-background-dark sticky inset-x-0 top-0 z-20 border-b">
                <Header />

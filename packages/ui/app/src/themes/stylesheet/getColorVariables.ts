...
export function getColorVariables(
    ...
    return {
        light: {
            ...
            [CSS_VARIABLES.GRAYSCALE_A1]: getRadixGrayAlphaVar(radixGrayscaleLight, 1),
            [CSS_VARIABLES.GRAYSCALE_A2]: getRadixGrayAlphaVar(radixGrayscaleLight, 2),
            [CSS_VARIABLES.GRAYSCALE_A3]: getRadixGrayAlphaVar(radixGrayscaleLight, 3),
            [CSS_VARIABLES.GRAYSCALE_A4]: getRadixGrayAlphaVar(radixGrayscaleLight, 4),
            [CSS_VARIABLES.GRAYSCALE_A5]: getRadixGrayAlphaVar(radixGrayscaleLight, 5),
            [CSS_VARIABLES.GRAYSCALE_A6]: getRadixGrayAlphaVar(radixGrayscaleLight, 6),
            [CSS_VARIABLES.GRAYSCALE_A7]: getRadixGrayAlphaVar(radixGrayscaleLight, 7),
            [CSS_VARIABLES.GRAYSCALE_A8]: getRadixGrayAlphaVar(radixGrayscaleLight, 8),
            [CSS_VARIABLES.GRAYSCALE_A9]: getRadixGrayAlphaVar(radixGrayscaleLight, 9),
            [CSS_VARIABLES.GRAYSCALE_A10]: getRadixGrayAlphaVar(radixGrayscaleLight, 10),
            [CSS_VARIABLES.GRAYSCALE_A11]: getRadixGrayAlphaVar(radixGrayscaleLight, 11),
            [CSS_VARIABLES.GRAYSCALE_A12]: getRadixGrayAlphaVar(radixGrayscaleLight, 12),
        ...
        dark: {
            ...
            [CSS_VARIABLES.GRAYSCALE_A10]: getRadixGrayAlphaVar(radixGrayscaleDark, 10),
            [CSS_VARIABLES.GRAYSCALE_A11]: getRadixGrayAlphaVar(radixGrayscaleDark, 11),
            [CSS_VARIABLES.GRAYSCALE_A12]: getRadixGrayAlphaVar(radixGrayscaleDark, 12),

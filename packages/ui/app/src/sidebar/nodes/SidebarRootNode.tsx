...
export const SidebarRootNode = memo(function SidebarRootNode({ node }: SidebarRootNodeProps): ReactElement | null {
    if (!node) {
        return null;
    }

    const children = node.children.flatMap((child): SidebarRootChildProps["node"][] => {

    ...
    return (
        <>
            {node.overviewPageId == null ? (
                <div className={clsx("fern-sidebar-heading px-6 py-2 flex items-center", className)}>
                    <span className="m-0 text-base leading-6 lg:text-[13px] font-semibold lg:leading-5">
                        {node.title}
                    </span>
                </div>
            ) : (

        ...
        <li ref={elementRef} className="scroll-my-32">
            ...
            >
                {range(0, depth).map((i) => (
                    <div
                        ...
                        className={classNames(
                            ...
                            "transition-transform group-hover/sidebar:translate-x-0 lg:translate-x-1 group-hover/sidebar:opacity-100 transition-opacity",
                            {
                ...
                {(toggleExpand != null || expanded) && (
                    <button
                        className={classNames(
                            "flex w-[44px] lg:w-6 justify-center items-center transition-colors rounded-none lg:rounded-lg transition-transform lg:translate-x-1 group-hover/sidebar:translate-x-0",
                            {

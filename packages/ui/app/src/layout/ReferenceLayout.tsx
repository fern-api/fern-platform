...
export function ReferenceLayout({
    ...
    return (
        <ContentWidthProvider width={isValidElement(aside) ? contentWidth : contentWidth * 2 + 48}>
            <main className="fern-reference-layout">
                <div className="z-10 w-full min-w-0 pt-8">
                    <article className="mx-auto w-full lg:ml-0 xl:mx-auto pb-20 max-w-content-width md:max-w-endpoint-width">
                        ...
                        <section
                            className={clsx(
                                "max-w-full prose dark:prose-invert prose-h1:mt-[1.5em] first:prose-h1:mt-0",
                                {
                                    "md:grid md:grid-cols-2 md:gap-8 lg:gap-12 max-md:space-y-12":

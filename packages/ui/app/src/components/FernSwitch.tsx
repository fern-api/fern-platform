...
export function FernSwitch(props: Switch.SwitchProps): ReactElement {
    return (
        <Switch.Root
            ...
            tabIndex={0}
        >
            <Switch.Thumb className="bg-background shadow-default block h-[21px] w-[21px] translate-x-0.5 rounded-full shadow-[0_2px_2px] transition-transform duration-100 will-change-transform data-[state=checked]:translate-x-[19px]" />
        </Switch.Root>
    );
}

...
export const CSS_VARIABLES = {
    BODY_FONT: "--typography-body-font-family" as const,
    HEADING_FONT: "--typography-heading-font-family" as const,
    CODE_FONT: "--typography-code-font-family" as const,
};

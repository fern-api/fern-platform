...
export function getClosestGrayScale(source: string): (typeof grayScaleNames)[number] {
    try {
...
export function getAlphaColorP3(targetColor: string, backgroundColor: string, targetAlpha?: number): string {
    const [r, g, b, a] = getAlphaColor(

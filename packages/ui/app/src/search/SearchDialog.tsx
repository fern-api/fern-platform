                ...
                <div className="flex min-h-screen items-start justify-center p-4">
                    ...
                    <div className="bg-background-primary-light dark:bg-background-primary-dark z-10 mx-3 mb-8 mt-10 flex w-full max-w-2xl flex-col overflow-hidden rounded-md text-left align-middle shadow-2xl">
                        <div className={classNames(styles.searchBox, "flex items-center space-x-3 px-5")}>
                            <Icon className="text-text-muted-light dark:text-text-muted-dark" icon="search" size={14} />
                            <SearchBox
                                inputMode="text"
                                autoFocus
                                ...
                                classNames={{
                                    ...
                                    submit: "hidden",
                                    submitIcon: "hidden",
                                    input: "w-full text-base text-text-muted-light dark:text-text-muted-dark placeholder:text-text-muted-light placeholder:dark:text-text-muted-dark bg-transparent py-5",
                                }}
                            />
                        </div>
                        <SearchHits />

...
export const ApiPlaygroundButton: FC<ApiPlaygroundSelectionState> = ({
    apiSection,
    apiDefinition,
    endpoint,
    example,
    ...
    return (
        <button
            type="button"
            onClick={() => {
                setSelectionStateAndOpen({ apiSection, apiDefinition, endpoint, example });
            }}
            className="hover:bg-tag-primary ring-border-primary dark:ring-border-primary-dark flex items-center gap-1 rounded-lg px-2 py-1 text-xs ring-1 transition-shadow hover:ring-2"
        >

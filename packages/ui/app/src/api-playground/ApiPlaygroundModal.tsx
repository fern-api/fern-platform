...
import { CaretDown, Cross, InfoSign, Plus } from "@blueprintjs/icons";
...
const ApiPlaygroundList: FC<ApiPlaygroundListProps> = ({ itemType, onChange, value }) => {
    ...
    return (
        <div>
                        ...
                        <li key={idx} className="flex gap-2">
                            <div className="flex-1">
                                <ApiPlaygroundTypeReference
                                    ...
                                    value={item}
                                    onChange={(newItem) => handleChangeItem(idx, newItem)}
                                />
                            </div>
                            <div>
            ...
            {valueAsList.length === 0 && (
                <Button icon={<Plus />} text="Add new element" onClick={appendItem} outlined={true} fill={true} />
            )}
        </div>
    );
};
...
const ApiPlaygroundMap: FC<ApiPlaygroundMapProps> = ({ keyType, valueType, onChange, value }) => {
    ...
    return (
        <div>
            ...
            {internalState.length === 0 && (
                <Button icon={<Plus />} text="Add new element" onClick={handleAppendItem} outlined={true} fill={true} />
            )}
        </div>
    );
};
...
const ApiPlaygroundObjectProperty: FC<ApiPlaygroundObjectPropertyProps> = ({ property, onChange, value }) => {
    ...
    const renderLabel = () => (
        <div className="shrink-1 flex min-w-0 flex-1 items-center justify-between">
            ...
            {property.description != null && (
                <Tooltip content={property.description} popoverClassName="max-w-xs text-xs" compact={true}>
                    <InfoSign size={14} className="opacity-30" />
                </Tooltip>
            )}
        </div>
    );
    ...
    return (
        <li className={classNames("flex gap-1 flex-col")}>
            {renderLabel()}
            <ApiPlaygroundTypeReference typeReference={property.valueType} onChange={handleChange} value={value} />
        </li>
    );
};
        ...
        <>
            ...
            >
                ...
                <div className="divide-border-default-light dark:divide-border-default-dark flex h-[500px] items-stretch divide-x">
                    ...
                    <div className="divide-border-default-light dark:divide-border-default-dark flex flex-1 flex-col divide-y">
                        <div className="flex-1">

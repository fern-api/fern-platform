                ...
                {tabs.map(({ title, toc = parentToc }, idx) => {
                    ...
                    return (
                        <RadixTabs.Trigger key={idx} value={idx.toString()} asChild>
                            <h6
                                className="text-default scroll-mt-header-height-padded hover:border-default data-[state=active]:t-accent data-[state=active]:border-accent-primary -mb-px flex max-w-max cursor-default whitespace-nowrap border-b border-transparent pb-2.5 pt-3 text-sm font-semibold leading-6"
                                id={id}

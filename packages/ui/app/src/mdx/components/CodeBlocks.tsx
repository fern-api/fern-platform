...
export const CodeBlocks: React.FC<React.PropsWithChildren<CodeBlocks.Props>> = ({ items }) => {
    ...
    const containerClass =
        "after:ring-default bg-card relative mt-4 mb-6 flex max-h-[400px] w-full min-w-0 max-w-full flex-col rounded-lg shadow-sm after:pointer-events-none after:absolute after:inset-0 after:rounded-[inherit] after:ring-1 after:ring-inset after:content-['']";

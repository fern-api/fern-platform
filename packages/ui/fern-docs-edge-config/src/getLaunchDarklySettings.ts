...
export async function getLaunchDarklySettings(domain: string): Promise<LaunchDarklyEdgeConfig | undefined> {
    const config = await get<Record<string, LaunchDarklyEdgeConfig>>("launchdarkly");

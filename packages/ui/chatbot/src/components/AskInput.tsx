...
export function AskInput({ onSend }: AskInputProps): ReactElement {
    const [value, setValue] = useState("");

    return (
        <div className="flex w-full items-center">
            <div className="flex w-full flex-col gap-1.5 rounded-[26px] p-1.5 transition-colors bg-[#f4f4f4] dark:bg-gray-900">

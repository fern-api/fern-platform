...
const nextConfig = {
    ...
    transpilePackages: [
         ...
         *
         * pnpm list --filter=@fern-platform/docs-bundle --only-projects --prod --recursive --depth=Infinity --json | jq -r '[.. | objects | select(.version | .!=null) | select(.version | startswith("link:")) | .from] | unique'
         */
        "@fern-api/fdr-sdk",
